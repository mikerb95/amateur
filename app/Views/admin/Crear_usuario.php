...
<!-- 🔓 Activamos edición SOLO en esta vista -->
    ...
    <div class="main-content">
        ...
        <div class="form-container">
            <form action="<?= base_url('admin/guardar_usuario') ?>" method="POST" class="styled-form">
                ...
                <!-- 🔓 Ahora este campo SÍ será editable -->
                <div class="form-group">
                ...
                <div class="form-buttons">
                    <button type="submit" class="btn-primary">
                        <img src="<?= base_url('imagenes/adduser.svg') ?>" alt="C_usuarios" class="botonañadir">
                        Registrar Usuario
                    </button>
                    <br>
                    <a href="<?= base_url('admin/usuarios') ?>" class="btn-secondary">
                        <img src="<?= base_url('imagenes/back.svg') ?>" alt="C_usuarios" class="botonback">
                        Volver
                    </a>
                </div>
